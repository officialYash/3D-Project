...
var G = "style[" + A + '][data-styled-version="5.3.8"]';
...
var H = function(e2) {
  ...
  r2.setAttribute(A, "active"), r2.setAttribute("data-styled-version", "5.3.8");
  var i2 = q();
  ...
  function e2() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (!t3)
        return "";
      var n2 = q();
      return "<style " + [n2 && 'nonce="' + n2 + '"', A + '="true"', 'data-styled-version="5.3.8"'].filter(Boolean).join(" ") + ">" + t3 + "</style>";
      ...
      if (e3.sealed)
        return j(2);
      var n2 = ((t3 = {})[A] = "", t3["data-styled-version"] = "5.3.8", t3.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, t3), o2 = q();
